 ...
 */
DefinitionBlock ("", "SSDT", 2, "XMCC  ", "Tpm2Tabl", 0x00001000)
{
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            OperationRegion (TNVS, SystemMemory, 0x44A7B000, 0x30)
            ...
            OperationRegion (CONA, SystemMemory, 0x44A7B030, 0x30)
            ...
            OperationRegion (STRT, SystemMemory, 0x44A7B060, 0x04)
