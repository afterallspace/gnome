 ...
 */
DefinitionBlock ("", "SSDT", 2, "XMCC  ", "UsbCTabl", 0x00001000)
{
    ...
    External (_SB_.PC00.LPCB.H_EC.RSV1, IntObj)
    External (_SB_.PC00.LPCB.H_EC.RSV2, IntObj)
    External (_SB_.PC00.LPCB.H_EC.USDC, IntObj)
    External (_SB_.PC00.LPCB.H_EC.USGC, IntObj)
    External (_SB_.PC00.LPCB.H_EC.VER1, IntObj)
    External (_SB_.PC00.LPCB.H_EC.VER2, IntObj)
                ...
                If ((Arg0 == ToUUID ("6f8398c2-7ca4-11e4-ad36-631042b5008f") /* Unknown UUID */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (One)
                        {
                            ...
                            \_SB.PC00.LPCB.H_EC.ECWT (0xE0, RefOf (\_SB.PC00.LPCB.H_EC.USDC))
                        }
                        Case (0x02)
                        {
                            ...
                            VER1 = \_SB.PC00.LPCB.H_EC.ECRD (RefOf (\_SB.PC00.LPCB.H_EC.VER1))
                            VER2 = \_SB.PC00.LPCB.H_EC.ECRD (RefOf (\_SB.PC00.LPCB.H_EC.VER2))
                            RSV1 = \_SB.PC00.LPCB.H_EC.ECRD (RefOf (\_SB.PC00.LPCB.H_EC.RSV1))
                            RSV2 = \_SB.PC00.LPCB.H_EC.ECRD (RefOf (\_SB.PC00.LPCB.H_EC.RSV2))
                            \_SB.PC00.LPCB.H_EC.ECWT (Zero, RefOf (\_SB.PC00.LPCB.H_EC.CCI0))
                            \_SB.PC00.LPCB.H_EC.ECWT (Zero, RefOf (\_SB.PC00.LPCB.H_EC.CCI3))
                            \_SB.PC00.LPCB.H_EC.ECWT (0xE1, RefOf (\_SB.PC00.LPCB.H_EC.USGC))
                        }
                        Case (0x03)
                        {
